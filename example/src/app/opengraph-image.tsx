...
export const alt =
  "activity-tabs — Headless tabs that keep panel state alive when switching.";
      ...
      >
        ...
        <div
          style={{
            ...
            height: 500,
            background:
              "radial-gradient(ellipse, rgba(168,85,247,0.25) 0%, transparent 70%)",
          }}
        />
        ...
        >
          <span
            style={{ fontFamily: "monospace", fontSize: 22, color: "#c084fc" }}
          >
